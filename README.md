...
* 😀 [Limine](https://github.com/limine-bootloader/limine) ⭐ 3,719 | 🐛 20 | 🌐 C | 📅 2026-09-13 - Modern, advanced, portable, multiprotocol bootloader.
...
* 🙂 [Ion](https://github.com/Andy-Python-Programmer/ion) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2021-10-03 - Modern x86\_64 UEFI bootloader

### Operating Systems

* 😀 [SerenityOS](https://github.com/SerenityOS/serenity) ⭐ 33,807 | 🐛 742 | 🌐 C++ | 📅 2026-09-12 - Graphical Unix-like operating system for x86 computers.
* 😀 [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,831 | 🐛 65 | 🌐 C | 📅 2026-09-12 - A completely-from-scratch hobby operating system: bootloader, kernel, drivers, C library, and userspace including a composited graphical UI, dynamic linker, syntax-highlighting text editor, network stack, etc.
* 🙂 [skiftOS](https://github.com/skiftOS/skift) ⭐ 2,982 | 🐛 7 | 🌐 C++ | 📅 2026-07-08 - A hobby operating system built from scratch in modern C++. Featuring a reactive UI library and a strong emphasis on user experience. (skiftOS is currently being rewritten so a lot of things might not work)
* 😀 [Managarm](https://github.com/managarm/managarm) ⭐ 1,977 | 🐛 221 | 🌐 C++ | 📅 2026-09-13 - Pragmatic microkernel-based OS with fully asynchronous I/O
...
* 😀 [Aero](https://github.com/Andy-Python-Programmer/aero) ⭐ 1,254 | 🐛 28 | 🌐 Rust | 📅 2025-04-07 - Aero is a new modern, experimental, unix-like operating system following the monolithic kernel design.
...
* 😀 [opuntiaOS](https://github.com/opuntiaOS-Project/opuntiaOS) ⭐ 662 | 🐛 15 | 🌐 C | 📅 2023-04-06 - An operating system targeting x86, ARMv7, and Aarch64
...
* 😀 [FlorenceOS](https://github.com/FlorenceOS/Florence) ⭐ 163 | 🐛 9 | 🌐 Zig | 📅 2022-08-22 - The Renaissance of Operating Systems
* 🙂 [Skylight](https://github.com/austanss/skylight) ⚠️ Archived - A clean, well-written minimalist operating system designed to be used as an educational material for operating system development.
* 😀 [Lyre](https://github.com/lyre-os/lyre) ⭐ 8 | 🐛 3 | 🌐 Shell | 📅 2026-03-04 - Lyre is an effort to write a modern, fast, and useful operating system.
* 🙂 [μ](https://github.com/cute-engineering/mu) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2023-08-05 - µ is a minimalist microkernel
* 🙂 [nyx](https://github.com/nyx-org/nyx) ⭐ 2 | 🐛 0 | 🌐 Shell | 📅 2025-06-18 - A simple operating system with a capability-based microkernel.
...
* 😀 [LAI](https://github.com/managarm/lai) ⭐ 187 | 🐛 23 | 🌐 C | 📅 2025-11-15 - LAI is an interpreter for AML, the ACPI Machine Language.
* 😀 [frigg](https://github.com/managarm/frigg) ⭐ 74 | 🐛 17 | 🌐 C++ | 📅 2026-08-26 - Lightweight C++ utilities and algorithms for system programming
* 😀 [lil](https://github.com/Matt8898/lil) ⭐ 54 | 🐛 0 | 🌐 C++ | 📅 2026-02-16 - A lightweight Intel GPU library
* 😀 [libheap](https://github.com/cute-engineering/libheap) ⭐ 18 | 🐛 0 | 🌐 C | 📅 2024-01-22 - A simple heap allocation library for hobby operating systems.
* 😀 [ACPICA](https://acpica.org) - A reference ACPI library for operating systems.

#### C Standard Libraries

* 😀 [mlibc](https://github.com/managarm/mlibc) ⭐ 1,133 | 🐛 98 | 🌐 C | 📅 2026-09-07 - Portable C standard library
...
* [cfenollosa/os-tutorial](https://github.com/cfenollosa/os-tutorial) ⭐ 30,701 | 🐛 130 | 🌐 C | 📅 2026-02-04 - A tutorial to make a complete operating system from a bootloader to a basic shell.
* [isometimes/rpi4-osdev](https://github.com/isometimes/rpi4-osdev) ⭐ 3,770 | 🐛 0 | 🌐 C | 📅 2026-09-03 - A tutorial to write a basic operating system for Raspberry Pi 4.
...
* [Xv6](https://github.com/mit-pdos/xv6-public) ⭐ 9,601 | 🐛 80 | 🌐 C | 📅 2024-08-13 \[[PDF](https://pdos.csail.mit.edu/6.828/2018/xv6/book-rev11.pdf)] - A modernized version of the classic Dennis Richie’s and Ken Thompson’s UNIX V6, written in ANSI C for x86 and [RISC-V](https://github.com/mit-pdos/xv6-riscv) ⭐ 10,365 | 🐛 2 | 🌐 C | 📅 2026-09-12.
* [MINIX 3.1.0](https://github.com/Stichting-MINIX-Research-Foundation/minix/tree/v3.1.0) ⭐ 3,506 | 🐛 126 | 🌐 C | 📅 2024-03-18 - The third version of MINIX for the 32-bit 386 protected mode. Appeared in the third edition of "Operating Systems: Design and Implementation" released in 2006, written by Andrew S. Tanebaum and Albert S. Woodhull.
...
* [MINIX 1.0](https://github.com/gdevic/minix1) ⭐ 403 | 🐛 1 | 🌐 C | 📅 2017-11-13 - The first version of MINIX for Intel 8088 real mode. First appeared in a book released in 1986 called "Operating Systems: Design and Implementation" written by Andrew S. Tanenbaum.
...
* [MINIX 2.0.0](https://github.com/leap0x7b/minix-2.0.0) ⭐ 13 | 🐛 0 | 🌐 C | 📅 2021-12-05 - The second version of MINIX for Intel 8088 real mode, the 16-bit 286 protected mode, and the 32-bit 386 protected mode. Appeared in the second edition of "Operating Systems: Design and Implementation" released in 1997, written by Andrew S. Tanebaum and Albert S. Woodhull.
...
* [RISC-V Manuals and Specifications](https://riscv.org/technical/specifications/)
  * [RISC-V Instruction Set Manual (Volume 1: Unprivileged ISA)](https://github.com/riscv/riscv-isa-manual/releases/download/draft-20211216-5651528/riscv-spec.pdf) ⭐ 4,812 | 🐛 177 | 🌐 TeX | 📅 2026-09-11 \[PDF]
  * [RISC-V Instruction Set Manual (Volume 2: Privileged Architecture)](https://github.com/riscv/riscv-isa-manual/releases/download/draft-20211216-5651528/riscv-privileged.pdf) ⭐ 4,812 | 🐛 177 | 🌐 TeX | 📅 2026-09-11 \[PDF]
...
* [OS X ABI Mach-O File Format Reference](https://github.com/aidansteele/osx-abi-macho-file-format-reference/raw/master/Mach-O_File_Format.pdf) ⭐ 882 | 🐛 2 | 📅 2024-10-13 \[PDF]
* [Executable and Linking Format Specification](https://refspecs.linuxfoundation.org/elf/elf.pdf) \[PDF]
  * [RISC-V ELF psABI Document](https://github.com/riscv-non-isa/riscv-elf-psabi-doc/releases/download/v1.0-rc1/riscv-abi.pdf) ⭐ 853 | 🐛 92 | 🌐 Python | 📅 2026-08-13 \[PDF]
