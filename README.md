...
* 😀 [Limine](https://github.com/limine-bootloader/limine) ⭐ 3,727 | 🐛 21 | 🌐 C | 📅 2026-09-14 - Modern, advanced, portable, multiprotocol bootloader.
...
* 😀 [SerenityOS](https://github.com/SerenityOS/serenity) ⭐ 33,835 | 🐛 739 | 🌐 C++ | 📅 2026-09-14 - Graphical Unix-like operating system for x86 computers.
* 😀 [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,832 | 🐛 65 | 🌐 C | 📅 2026-09-12 - A completely-from-scratch hobby operating system: bootloader, kernel, drivers, C library, and userspace including a composited graphical UI, dynamic linker, syntax-highlighting text editor, network stack, etc.
...
* 😀 [Lemon OS](https://github.com/LemonOSProject/LemonOS) ⭐ 1,298 | 🐛 15 | 🌐 C++ | 📅 2024-11-23 - Lemon OS is a UNIX-like 64-bit operating system written in C++.
...
* 😀 [frigg](https://github.com/managarm/frigg) ⭐ 74 | 🐛 18 | 🌐 C++ | 📅 2026-09-14 - Lightweight C++ utilities and algorithms for system programming
...
* 😀 [mlibc](https://github.com/managarm/mlibc) ⭐ 1,133 | 🐛 96 | 🌐 C | 📅 2026-09-14 - Portable C standard library
...
* [cfenollosa/os-tutorial](https://github.com/cfenollosa/os-tutorial) ⭐ 30,703 | 🐛 130 | 🌐 C | 📅 2026-02-04 - A tutorial to make a complete operating system from a bootloader to a basic shell.
...
* [Xv6](https://github.com/mit-pdos/xv6-public) ⭐ 9,605 | 🐛 80 | 🌐 C | 📅 2024-08-13 \[[PDF](https://pdos.csail.mit.edu/6.828/2018/xv6/book-rev11.pdf)] - A modernized version of the classic Dennis Richie’s and Ken Thompson’s UNIX V6, written in ANSI C for x86 and [RISC-V](https://github.com/mit-pdos/xv6-riscv) ⭐ 10,389 | 🐛 2 | 🌐 C | 📅 2026-09-13.
* [MINIX 3.1.0](https://github.com/Stichting-MINIX-Research-Foundation/minix/tree/v3.1.0) ⭐ 3,505 | 🐛 126 | 🌐 C | 📅 2024-03-18 - The third version of MINIX for the 32-bit 386 protected mode. Appeared in the third edition of "Operating Systems: Design and Implementation" released in 2006, written by Andrew S. Tanebaum and Albert S. Woodhull.
...
* [RISC-V Manuals and Specifications](https://riscv.org/technical/specifications/)
  * [RISC-V Instruction Set Manual (Volume 1: Unprivileged ISA)](https://github.com/riscv/riscv-isa-manual/releases/download/draft-20211216-5651528/riscv-spec.pdf) ⭐ 4,816 | 🐛 197 | 🌐 TeX | 📅 2026-09-14 \[PDF]
  * [RISC-V Instruction Set Manual (Volume 2: Privileged Architecture)](https://github.com/riscv/riscv-isa-manual/releases/download/draft-20211216-5651528/riscv-privileged.pdf) ⭐ 4,816 | 🐛 197 | 🌐 TeX | 📅 2026-09-14 \[PDF]
...
* [Executable and Linking Format Specification](https://refspecs.linuxfoundation.org/elf/elf.pdf) \[PDF]
  * [RISC-V ELF psABI Document](https://github.com/riscv-non-isa/riscv-elf-psabi-doc/releases/download/v1.0-rc1/riscv-abi.pdf) ⭐ 855 | 🐛 92 | 🌐 Python | 📅 2026-08-13 \[PDF]
