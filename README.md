...
* 😀 [Limine](https://github.com/limine-bootloader/limine) ⭐ 3,758 | 🐛 23 | 🌐 C | 📅 2026-09-14 - Modern, advanced, portable, multiprotocol bootloader.
...
* 😀 [SerenityOS](https://github.com/SerenityOS/serenity) ⭐ 33,847 | 🐛 737 | 🌐 C++ | 📅 2026-09-21 - Graphical Unix-like operating system for x86 computers.
* 😀 [ToaruOS](https://github.com/klange/toaruos) ⭐ 6,839 | 🐛 65 | 🌐 C | 📅 2026-09-21 - A completely-from-scratch hobby operating system: bootloader, kernel, drivers, C library, and userspace including a composited graphical UI, dynamic linker, syntax-highlighting text editor, network stack, etc.
...
* 😀 [Managarm](https://github.com/managarm/managarm) ⭐ 1,981 | 🐛 220 | 🌐 C++ | 📅 2026-09-21 - Pragmatic microkernel-based OS with fully asynchronous I/O
...
* 😀 [mlibc](https://github.com/managarm/mlibc) ⭐ 1,138 | 🐛 95 | 🌐 C | 📅 2026-09-15 - Portable C standard library
...
* [cfenollosa/os-tutorial](https://github.com/cfenollosa/os-tutorial) ⭐ 30,720 | 🐛 129 | 🌐 C | 📅 2026-02-04 - A tutorial to make a complete operating system from a bootloader to a basic shell.
...
* [Xv6](https://github.com/mit-pdos/xv6-public) ⭐ 9,619 | 🐛 80 | 🌐 C | 📅 2024-08-13 \[[PDF](https://pdos.csail.mit.edu/6.828/2018/xv6/book-rev11.pdf)] - A modernized version of the classic Dennis Richie’s and Ken Thompson’s UNIX V6, written in ANSI C for x86 and [RISC-V](https://github.com/mit-pdos/xv6-riscv) ⭐ 10,427 | 🐛 3 | 🌐 C | 📅 2026-09-19.
