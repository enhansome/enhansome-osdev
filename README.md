...
* 😀 [Limine](https://github.com/limine-bootloader/limine) ⭐ 3,645 | 🐛 17 | 🌐 C | 📅 2026-08-25 - Modern, advanced, portable, multiprotocol bootloader.
...
* 😀 [SerenityOS](https://github.com/SerenityOS/serenity) ⭐ 33,791 | 🐛 737 | 🌐 C++ | 📅 2026-08-27 - Graphical Unix-like operating system for x86 computers.
...
* 😀 [Managarm](https://github.com/managarm/managarm) ⭐ 1,970 | 🐛 215 | 🌐 C++ | 📅 2026-08-27 - Pragmatic microkernel-based OS with fully asynchronous I/O
...
* [Xv6](https://github.com/mit-pdos/xv6-public) ⭐ 9,582 | 🐛 80 | 🌐 C | 📅 2024-08-13 \[[PDF](https://pdos.csail.mit.edu/6.828/2018/xv6/book-rev11.pdf)] - A modernized version of the classic Dennis Richie’s and Ken Thompson’s UNIX V6, written in ANSI C for x86 and [RISC-V](https://github.com/mit-pdos/xv6-riscv) ⭐ 10,270 | 🐛 8 | 🌐 C | 📅 2026-08-24.
...
* [RISC-V Manuals and Specifications](https://riscv.org/technical/specifications/)
  * [RISC-V Instruction Set Manual (Volume 1: Unprivileged ISA)](https://github.com/riscv/riscv-isa-manual/releases/download/draft-20211216-5651528/riscv-spec.pdf) ⭐ 4,789 | 🐛 176 | 🌐 TeX | 📅 2026-08-26 \[PDF]
  * [RISC-V Instruction Set Manual (Volume 2: Privileged Architecture)](https://github.com/riscv/riscv-isa-manual/releases/download/draft-20211216-5651528/riscv-privileged.pdf) ⭐ 4,789 | 🐛 176 | 🌐 TeX | 📅 2026-08-26 \[PDF]
